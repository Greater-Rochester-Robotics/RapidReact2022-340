...
public class AutoDriveStraightBackAndShootHigh extends SequentialCommandGroup {
  /** Creates a new AutoDriveStraightBackAndShootHigh. */
  public AutoDriveStraightBackAndShootHigh(double distanceInMeters) {
